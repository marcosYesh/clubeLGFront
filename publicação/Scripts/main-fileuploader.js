...
$(function () {
    ...
    //var fileUploadUrl = "/Backload/UploadHandler?objectContext=" + userID;

    // Demo 1: Call the asynchronous method of the derived handler (version 1.9+)
    // var fileUploadUrl = "/FileUploadDerived/FileHandler";

    // get values inserted at AccountController/Create
    var userID = $('#userID').val();

    // Demo 2: Call the instantiated handler method
    var fileUploadUrl = "/FileUploadInstance/FileHandler?objectContext=" + userID;
