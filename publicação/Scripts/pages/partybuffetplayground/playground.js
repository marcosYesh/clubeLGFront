...
function getAllCurrent(partyBuffetId, callback) {
    $.ajax({
        url: baseUrl + '/api/partybuffetplayground/getAllCurrent?partyBuffetId=' + partyBuffetId,
        type: 'GET',
        dataType: 'json',
        success: function (data) {
...
function getByPlaygroundId(id, callback) {
    $.ajax({
        url: baseUrl + '/api/partybuffetplayground/Get?id=' + id,
        type: 'GET',
        dataType: 'json',
        success: function (data) {
            return callback(data.ReturnData);
...
function getByPlaygroundIdByCPF(id, callback) {
    $.ajax({
        url: baseUrl + '/api/partybuffetplayground/GetByCPF?id=' + id,
        type: 'GET',
        dataType: 'json',
        success: function (data) {
            return callback(data.ReturnData);
...
function postPausetime(playgroundId, callback) {
    $.ajax({
        url: baseUrl + '/api/partybuffetplayground/pause',
        type: 'POST',
        dataType: 'json',
        data: {
...
function postPlaytime(playgroundId, callback) {
    $.ajax({
        url: baseUrl + '/api/partybuffetplayground/start',
        type: 'POST',
        dataType: 'json',
        data: {
            'PlaygroundId': playgroundId,
