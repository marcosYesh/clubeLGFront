...
function loadAll() {
    getAllCurrent(selectedPartyBuffetId, function (dataArray) {
        $('.table-playgound-body').empty();
        $('.table-playgound-body').prepend('<tr class="grid-row"><td class="grid-cell" colspan="14" style="padding: 5px 0;"><a onclick="openCheckinModal()" style="text-decoration: none !important; color: #000; width: 100%; height: 45px; padding: 13px 0" class="btn btn-xs btn-primary btn-checkin"</a>ADICIONAR PARTICIPANTE<i class="fa fa-sign-in" style="margin-left:5px;"></i></td></tr>');
        $.each(dataArray, function (index, value) {
...
function getAllCurrent(partyBuffetId, callback) {
    $.ajax({
        url: baseUrl + '/api/eventplayground/getAllCurrent?partyBuffetId=' + partyBuffetId,
        type: 'GET',
        dataType: 'json',
        success: function (data) {
...
function getByPlaygroundId(id, callback) {
    $.ajax({
        url: baseUrl + '/api/eventplayground/Get?id=' + id,
        type: 'GET',
        dataType: 'json',
        success: function (data) {
            return callback(data.ReturnData);
...
function getByPlaygroundIdByCPF(id, callback) {
    $.ajax({
        url: baseUrl + '/api/eventplayground/GetByCPF?id=' + id,
        type: 'GET',
        dataType: 'json',
        success: function (data) {
            return callback(data.ReturnData);
...
function postPausetime(playgroundId, callback) {
    $.ajax({
        url: baseUrl + '/api/eventplayground/pause',
        type: 'POST',
        dataType: 'json',
        data: {
...
function postPlaytime(playgroundId, callback) {
    $.ajax({
        url: baseUrl + '/api/eventplayground/start',
        type: 'POST',
        dataType: 'json',
        data: {
            'PlaygroundId': playgroundId,
