...
function searchResponsibleByCpf(cpf, callback) {
    $.ajax({
        url: baseUrl + '/api/eventplayground/GetResponsible?cpf=' + cpf,
        type: 'GET',
        dataType: 'json',
...
function searchChildrenByResponsibleCpf(cpf, callback) {
    $.ajax({
        url: baseUrl + '/api/eventplayground/GetUserSubscription?cpf=' + cpf,
        type: 'GET',
        dataType: 'json',
        success: function (data) {
            callback(data.ReturnData);
...
function searchGetChild(cpf, callback) {
    $.ajax({
        url: baseUrl + '/api/eventplayground/GetChild?cpf=' + cpf,
        type: 'GET',
        dataType: 'json',
        success: function (data) {
            callback(data.ReturnData);
...
function registerResponsible(dataInput, callback) {
    $.ajax({
        url: baseUrl + '/api/eventplayground/RegisterResponsible',
        type: 'POST',
        dataType: 'json',
        data: dataInput,
        success: function (data) {
