...
function srvCheckOut(dataInput, callback) {
    ...
    $.ajax({
        url: baseUrl + '/api/babycarriageplayground/checkout',
        type: 'POST',
        dataType: 'json',
        data: dataInput,
...
function srvCalculateCost(id, userSubscriptionId, callback) {
    $.ajax({
        url: baseUrl + '/api/babycarriageplayground/calculateCost?id=' + id + '&userSubscriptionId=' + userSubscriptionId,
        type: 'GET',
        dataType: 'json',
        success: function (data) {
            callback(data.ReturnData);
...
function srvUpdateUserStorePriceLabel(id, label, callback) {
    $.ajax({
        url: baseUrl + '/api/babycarriageplayground/updateUserStorePriceLabel',
        type: 'POST',
        dataType: 'json',
        data: {
            'playgroundId': id,
