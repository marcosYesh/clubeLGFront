...
function searchResponsibleByCpf(cpf, callback) {
    $.ajax({
        url: baseUrl + '/api/partybuffetplayground/GetResponsible?cpf=' + cpf,
        type: 'GET',
        dataType: 'json',
...
function searchChildrenByResponsibleCpf(cpf, callback) {
    $.ajax({
        url: baseUrl + '/api/partybuffetplayground/GetUserSubscription?cpf=' + cpf,
        type: 'GET',
        dataType: 'json',
        success: function (data) {
            callback(data.ReturnData);
...
function searchGetChild(cpf, callback) {
    $.ajax({
        url: baseUrl + '/api/partybuffetplayground/GetChild?cpf=' + cpf,
        type: 'GET',
        dataType: 'json',
        success: function (data) {
            callback(data.ReturnData);
...
function registerResponsible(dataInput, callback) {
    $.ajax({
        url: baseUrl + '/api/partybuffetplayground/RegisterResponsible',
        type: 'POST',
        dataType: 'json',
        data: dataInput,
        success: function (data) {
