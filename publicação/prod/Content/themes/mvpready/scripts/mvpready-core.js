...
var mvpready_core = function () {
  ...
  var getLayoutColors = function () {
    ...
    colors = ['#d74b4b', '#475F77', '#BCBCBC', '#777777', '#6685a4', '#E68E8E', '#FFFFFF'] // Slate
  ...
  var getDashboardColors = function () {
      return ['#2488D3', '#2A7F2E', '#BDBE01', '#E2A300', '#003DFD'] // azul, verde, amarelo, ...
  }
  ...
  return {    
    ...
    dashboardColors: getDashboardColors()
  }
