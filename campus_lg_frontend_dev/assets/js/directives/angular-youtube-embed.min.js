...
angular.module('youtube-embed', [])
    ...
    .directive('youtubeVideo', ['$window', 'youtubeEmbedUtils', '$rootScope', '$timeout', function ($window, youtubeEmbedUtils, $rootScope, $timeout) {
        var uniqId = 1;
            ...
            link: function (scope, element, attrs) {
                ...
                function onPlayerStateChange(event) {
                    ...
                    setInterval(function () {
                        $rootScope.currentTime = event.target.getCurrentTime();
                        $rootScope.duration = event.target.getDuration();
                        $rootScope.$apply();
                    }, 300);
                ...
                function loadPlayer() {
                    if (scope.videoId || scope.playerVars.list) {
                        ...
                        $rootScope.youtubePlayer = scope.player;
                    }
                };
