...
(function Service($angular) {
    ...
    function videoService($rootScope, $timeout, ngVideoPlaylist, $scope) {
            ...
            controller: ['$rootScope', '$scope', '$interval', '$window', 'ngVideoOptions',
                ...
                function controller($rootScope, $scope, $interval, $window, ngVideoOptions) {
                    ...
                    $scope.grabStatistics = function grabStatistics() {
                        ...
                        $rootScope.currentTime = player.currentTime;
                        $rootScope.duration = $scope.duration;
                        $rootScope.player = $scope.player;
                        $rootScope.playing = $scope.playing;
